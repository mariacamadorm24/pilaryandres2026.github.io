...
window.WEDDING_CONFIG = {
  ...
  dressCode: {
    title: "Cocktail",
    men: "Traje de colores oscuros o claros, con telas respirables.",
  ...
  // ------------------------------------------------------------------
  photos: {
    hero: "assets/gallery/foto-8.jpg"
  },
  ...
  // Cada foto vive en assets/gallery/. Sin texto debajo de las fotos.
  // ------------------------------------------------------------------
  gallery: {
    images: [
      { src: "assets/gallery/foto-1.jpg", alt: "Pilar y Andrés en una cafetería" },
      { src: "assets/gallery/foto-2.jpg", alt: "Pilar y Andrés en Madrid, frente a la Plaza de Toros de Las Ventas" },
      { src: "assets/gallery/foto-3.jpg", alt: "Pilar y Andrés de noche frente a la Torre Eiffel" },
      { src: "assets/gallery/foto-4.jpg", alt: "Pilar y Andrés en una fiesta" },
      { src: "assets/gallery/foto-5.jpg", alt: "Pilar y Andrés en la playa, en la Riviera Maya" },
      { src: "assets/gallery/foto-6.jpg", alt: "Pilar y Andrés el día de su graduación" },
      { src: "assets/gallery/foto-7.jpg", alt: "Pilar y Andrés sentados en una plaza iluminada de noche" },
      { src: "assets/gallery/foto-8.jpg", alt: "Pilar y Andrés frente a la Torre Eiffel" }
    ]
  }
};
