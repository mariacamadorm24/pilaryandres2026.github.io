...
window.WEDDING_CONFIG = {
  ...
  // ------------------------------------------------------------------
  meta: {
    title: "Pilar & Felipe — 31 de Octubre de 2026",
    description:
      "Acompáñanos a celebrar la boda de Pilar y Felipe el 31 de octubre de 2026 en Vélez, Santander. Confirma tu asistencia aquí.",
  ...
  event: {
    ...
    heroKicker: "Acompáñanos a celebrar nuestra boda",
    entranceKicker: "Te invitamos a nuestra boda"
  },
  ...
  welcome: {
    eyebrow: "Bienvenidos",
    message:
      "Pilar Martínez Serrano y Felipe Reyes Pérez, tenemos el gusto de invitarlos a nuestra boda."
  },
  ...
  dressCode: {
    ...
    avoidColors: [
      { name: "Vino tinto", hex: "#6E1F2E" },
      { name: "Fucsia", hex: "#D6336C" },
      { name: "Blanco", hex: "#FAF8F2" }
    ],
    avoidNote: "Por favor, absténganse de usar estos colores.",
    referenceLinks: {
      women: "https://co.pinterest.com/pilaryandres2026/vestuario-mujeres/?invite_code=29e74ba53a0f47fda9e2f7fee9f43eb5&sender=1132514774954351606",
      men: "https://co.pinterest.com/pilaryandres2026/vestuario-hombres/?invite_code=aecf767b91ce46b982f438af78e77710&sender=1132514774954351606"
    },
    // Un solo Pin (imagen) representativo por tablero, para la vista previa.
    referencePins: {
      women: "https://co.pinterest.com/pin/877990889849526098/",
      men: "https://co.pinterest.com/pin/1132514637577711916/"
    }
  },
  ...
  additionalInfo: [
    ...
    },
    {
      ...
      bullets: [
        "Se recomienda vestuario cómodo y acorde a evento al aire libre, así como llevar abrigo para la noche.",
        "Tener en cuenta calzado adecuado para jardín.",
        "La recepción se realizará a 30 minutos de la catedral.",
        "El acceso a la recepción es por vía destapada, por lo que recomendamos el uso de vehículos altos."
      ]
    }
  ],

  // ------------------------------------------------------------------
  // AVISO DE REGALOS — banda destacada justo debajo del dress code.
  // ------------------------------------------------------------------
  giftsBanner: {
    text: "Regalos: lluvia de sobres",
    photo: "regalos-fondo.jpg"
  },
  ...
  // ------------------------------------------------------------------
  rsvp: {
    deadlineText: "El plazo máximo para confirmar tu asistencia es el 9 de octubre de 2026.",
    attendanceOptions: [
  ...
  // en la pantalla de entrada. El archivo "cancion.mp3" va en la raíz
  ...
  gallery: {
    images: [
      { src: "foto-1.jpg", alt: "Pilar y Felipe en una cafetería" },
      { src: "foto-2.jpg", alt: "Pilar y Felipe en Madrid, frente a la Plaza de Toros de Las Ventas" },
      { src: "foto-3.jpg", alt: "Pilar y Felipe de noche frente a la Torre Eiffel" },
      { src: "foto-4.jpg", alt: "Pilar y Felipe en una fiesta" },
      { src: "foto-5.jpg", alt: "Pilar y Felipe en la playa, en la Riviera Maya" },
      { src: "foto-6.jpg", alt: "Pilar y Felipe el día de su graduación" },
      { src: "foto-7.jpg", alt: "Pilar y Felipe sentados en una plaza iluminada de noche", position: "top" },
      { src: "foto-8.jpg", alt: "Pilar y Felipe frente a la Torre Eiffel" }
    ]
  }
};
