...
window.WEDDING_CONFIG = {
  ...
  // ------------------------------------------------------------------
  itinerary: [
    { time: "3:00 p. m.", title: "Ceremonia", detail: "Catedral Nuestra Señora de las Nieves" },
  ...
  theme: {
    ...
    colors: {
      ...
      sage: "#7c8c68",        // verde salvia (etiquetas, hojas)
      sageDeep: "#566047",    // salvia oscuro
      rose: "#c2607a",        // rosa de acento (títulos pequeños, botón RSVP)
      mauve: "#8c5468",       // malva (firma, detalles de flores)
      gold: "#b6903a",        // dorado (líneas divisorias, centros de flores)
      goldLight: "#e6cfa0"    // dorado claro
    },

    // Ilustraciones florales: tamaño, intensidad y si aparecen a los
    // costados de toda la página en pantallas grandes.
    ornaments: {
      heroScale: 1,              // 0.8 = más pequeñas, 1.3 = más grandes
      sectionBloomOpacity: 0.85, // 0 a 1 — qué tan visibles son en cada sección
      pageBordersEnabled: true,  // bordes florales fijos en pantallas anchas
      pageBordersOpacity: 0.28
    },
