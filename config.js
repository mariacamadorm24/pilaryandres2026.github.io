...
window.WEDDING_CONFIG = {
  ...
  // ------------------------------------------------------------------
  itinerary: [
    { time: "3:00 p. m.", title: "Ceremonia", detail: "Catedral Nuestra Señora de las Nieves", icon: "church" },
    { time: "6:30 p. m.", title: "Recepción y fiesta", detail: "Hotel Ecolodge Macúa", icon: "toast" }
  ],
  ...
  // Sube tus fotos a una carpeta "assets/gallery/" junto a index.html
  // y agrega una entrada aquí por cada una. Si dejas el arreglo vacío,
  // la sección muestra un aviso de "próximamente" en vez de verse rota.
  // Ejemplo:
  // { src: "assets/gallery/foto-1.jpg", alt: "Pilar y Andrés en la playa", caption: "Verano 2022" }
  // ------------------------------------------------------------------
  gallery: {
    images: []
  }
